import { useAdminProductPage } from "../hooks/useAdminProductPage.js";
...
const AdminProductPage = () => {
  ...
  const deleteNoticeProduct = deleteNotice
    ? products.find((product) => product.id === deleteNotice.productId)
    : null;
      ...
      {isLoading ? (
        ...
        <>
          {deleteNotice ? (
            <div
              role="alert"
              className="alert alert-warning mb-4 items-start text-sm sm:items-center"
            >
              <AlertTriangleIcon className="size-5" aria-hidden />
              <span className="min-w-0 flex-1">{deleteNotice.message}</span>
              <div className="ml-auto flex items-center gap-1">
                {deleteNoticeProduct ? (
                  <button
                    ...
                    onClick={() => {
                      setEditing(deleteNoticeProduct);
                      setModalOpen(true);
