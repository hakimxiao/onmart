  ...
  return (
    <div className=" space-y-8 text-left">
        ...
        <div className="bg-linear-to-br from-primary/12 via-base-100 to-base-200/90 px-5 py-6 sm:px-8 sm:py-8">
          <div className="flex flex-col gap-6 lg:flex-row lg:items-start lg:justify-between">
            ...
            <div className="flex flex-col gap-3 border-t border-base-300/80 pt-4 lg:border-t-0 lg:pt-0 lg:text-right">
              <span
                className={`badge badge-lg w-fit capitalize lg:ml-auto ${paid ? "badge-success" : order.status === "pending" ? "badge-warning" : "badge-error"}`}
              >
                {order.status}
              </span>
      ...
      <div>
        ...
        <div className="tabs tabs-boxed mt-3 w-fit flex-wrap bg-base-300/5 p-1">
        ...
        <div className="mt-5">
          {/* Outlet digunakan untuk memanggil komponen di dalamnya, Jadi bagian ini yang dirender secara dinamis
            jadi halaman url nya akan berubah sehingga menghasilkan halaman baru pada bagian div ini
          */}
