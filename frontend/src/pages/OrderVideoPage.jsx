...
const OrderVideoPage = () => {
  ...
  const { call, client, error, id, isLoading, loadError, order, paid } =
    useOrderVideoPage();
  ...
  if (loadError || !order) {
    return (
      <PageError
        ...
        action={{ to: "/orders", label: "Baclk to orders" }}
      />
    );
  }
  ...
  return (
    <div className="space-y-4 text-left">
      ...
      <div className="flfex min-h-130 flex-col overflow-hidden rounded-box border border-base-300 bg-base-100">
