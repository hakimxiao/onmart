...
import { TrusrtStrip } from "../components/TrustStrip";
      ...
      <section id="catalog" className="scroll-mt-24">
        <div className="mb-6 flex flex-col gap-4 sm:flex-row sm:items-end sm:justify-between">
          ...
          <div className="flex flex-wrap gap-2">
            ...
            {categoryChipsLoading
              ? [1, 2, 3, 4].map((i) => (
                  <div key={i} className="skeleton h-8 w-20" aria-hidden />
                ))
              : categories.map((c) => (
                  <button
                    key={c}
        ...
        {loadingList ? (
          ...
          <PageError message="Kami tidak dapat memuat produk. Silakan coba lagi sebentar lagi." />
        ) : products.loadingCategories === 0 ? (
